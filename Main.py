def main():
    ...
    p2_ships = Battleship_Drag.p2_ship_loca
    print(p1_ships)
    print(p2_ships)
    ...
    for l in range(0, 6):
        ...
        print('Length of Ship: ', box_len_p1_ship, '\n')
    ...
    print('P2 Ships Location: ', p2_ships_refined, '\n')
    ...
    if p1_ship_des>p2_ship_des:
        ...
        header = font.render('OUT OF AMMUNITIONS',True,'black')
        text = font_small.render('Player 2 Got the Most Hits',True,'black')
