def menu():
    ...
    button_exit = Button(520, 350, exit_img, 1)
    button_info = Button(520, 500, info_img, 1)
    ...
    while running:
        ...
        if button_exit.draw()[1]:
            ...
            button_exit = Button(520, 350, exit_hov_img, 1)
        else:
            button_exit = Button(520, 350, exit_img, 1)

        if button_info.draw()[1]:
            #print('Hovering on Exit')
            button_info = Button(520, 500, info_hov_img, 1)
        else:
            button_info = Button(520, 500, info_img, 1)
